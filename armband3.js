...
function Armband3(printer, material,style, pos,  rows, stitches){
  ...
  this.knitgrid.disorderCosWave(4,34,3, PI/13)
...
// layer 0
  ...
  this.knittings[i].createPattern("straight", 1,38);
  this.knittings[i].createPattern("end",38,39);
