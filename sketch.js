...
function create(){
  ...
  institches = floor(sliderStitches.value());
  inrows = floor(sliderRows.value());
  pos = createVector(6,3);
  if(inrows  > 0){
  
    knitting = new Lapje("Ultimaker2+", "PLA", "normal", pos, institches, inrows,checkShowGrid.checked()  );
