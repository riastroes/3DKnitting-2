...
Stitch.prototype.create =function(){
    switch(this.type){
       ...
       case 'S': {               //R laatste rechts
         ...
         this.stitch[10] = new Pos(2,1,1,0);
         this.stitch[11] = new Pos(3,0,1,0);
         this.stitch[12] = new Pos(4,1,1,0);
        this.stitch[13] = new Pos(4,3,1,0);
        break;
       }
       case 'L': {               //R naar links
       ...
       case '-': {                //R afhechten, laatste steek
         this.stitch[0] = new Pos(4,0,0,0);
        break;
       }
       case '_': {                //R afhechten, laatste steek
         this.stitch[0] = new Pos(-4,0,0,0);
        break;
       }
       case '|': {                //2 zakken
         this.stitch[0] = new Pos(0,2,0,0);
        break;
       }
